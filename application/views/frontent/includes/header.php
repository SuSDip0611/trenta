...
<body class="js">
		...
		<div class="middle-inner" id="navbar">
			<div class="container px-4">
				<div class="d-flex flex-wrap">
					<div class="col-lg-2 col-md-2 col-12 leftLogo">
						<div class="logo d-sm-nun">
							<a href="#">
								<img src="<?= base_url(); ?>assets/frontent/images/logoD.png" alt="logo">
							</a>
						</div>
					</div>
					<div class="left_menu aismc flex_responsive d-flex jcse">
						<a href="" class="linearGrad fs2rem">Home</a>
						<a href="" class="ml_md_3 sm_mt_10 linearGrad fs2rem">About Us</a>
					</div>
					<div class="logo d-sm-nun ml-auto centerLogo sm_mt_10 col-md-2 col-lg-2">
						<a href="#">
							<img src="<?= base_url(); ?>assets/frontent/images/logoD.png" alt="logo">
						</a>
					</div>
					<div class="d-flex flex-row ml-auto" style="right: -8%;">
						<div class="search-bar">
							<div class="input-group brdr linearGrad">
								...
								<div class="input-group-append searchIcon">
									<span class="input-group-text mx-auto" id="basic-addon2"><i class="ti-search"></i></span>
								</div>
							</div>
						</div>
						...
						<div class="ml-2 headerIcon">
							<div class="right-bar">
								<!-- Search Form -->
								<div class="sinlge-bar">
									<a href="#" class="single-icon"><i class="linearGrad fs2rem fa fa-heart-o" aria-hidden="true"></i></a>
								</div>
								<div class="sinlge-bar">
									<a href="#" class="single-icon"><i class="linearGrad fs2rem fa fa-user-circle-o" aria-hidden="true"></i></a>
								</div>
								<div class="sinlge-bar shopping">
									<a href="#" class="single-icon"><i class="linearGrad fs2rem ti-bag"></i> <span class="total-count">2</span></a>
									<!-- Shopping Item -->
									...
									<div class="navbar-collapse">
										<div class="nav-inner">
											<ul class="nav main-menu menu navbar-nav">
												<li class="active"><a href="#"><img src="<?= base_url(); ?>assets/frontent/images/logoD.png" style="width:110px"></a></li>
	...
	<script>
		...
		var sticki = navbar.offsetTop;

		function myFunction() {
			if (window.pageYOffset >= sticki) {
